...
-- Volcando estructura para tabla bdstoy.admin
...
-- Volcando datos para la tabla bdstoy.admin: ~1 rows (aproximadamente)
INSERT INTO `admin` (`usuario`, `password`, `dni`) VALUES
	('Kevin', '1234', 1515);
...
INSERT INTO `parametro` (`total_clases`, `promocion`, `libre`, `regular`, `id`) VALUES
	(1, 1, 1, 1, 1);
