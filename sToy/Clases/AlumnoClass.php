...
class Alumno{
    ...
    public static function actualizarAlumno($nombre,$apellido,$dni,$fecha_nacimiento){
        $consulta = ("UPDATE alumno SET nombre = '$nombre', apellido = '$apellido', dni = '$dni', fecha_nac = '$fecha_nacimiento' WHERE dni_alumno = '$dni'");
        return $consulta;
    }
