...
<body>
    ...
    <div class="container-fondo d-flex justify-content-center align-items-center" style="height: 88vh">
        <div class="container d-flex justify-content-center text-center align-items-center" style="height: 50vh">
            <div style="width: 50vh">
                <img src="../Multimedia/icono.png" class="" style="margin-bottom: 10px; margin-top: 80px; ">
                <form action="" style="margin-bottom: 0px; ">
                    <input type="text" id="fname" name="fname" placeholder="Ingrese un dni" onkeyup="sugerencia(this.value)">
                </form>
                    ...
                    if (isset($_GET["dni"])) {
                        ...
                        if (!empty($dni)) {
                            ...
                            if ($alumno) {
                                ...
                                $consulta = Asistencia::presente($dni, $fecha);
